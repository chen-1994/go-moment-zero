...
const (
	Gender_MAIL    Gender = 0
	Gender_FE_MAIL Gender = 1
)
...
const file_person_proto_rawDesc = "" +
	"\n" +
	"\fperson.proto\x12\x05proto\"U\n" +
	"\x06person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03age\x18\x02 \x01(\x05R\x03age\x12%\n" +
	"\x06gender\x18\x03 \x01(\x0e2\r.proto.GenderR\x06gender*\x1f\n" +
	"\x06Gender\x12\b\n" +
	"\x04MAIL\x10\x00\x12\v\n" +
	"\aFE_MAIL\x10\x01B\vZ\t./;personb\x06proto3"
...
var file_person_proto_depIdxs = []int32{
	0, // 0: proto.person.gender:type_name -> proto.Gender
